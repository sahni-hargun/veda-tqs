  ...
  return (
    ...
    <footer id="footer">
     <div className="footer">
       ...
       <a className="instagram" href="https://www.instagram.com/vedathequiz" style={{marginLeft: '20px'}} target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
       <p style={{color: 'white'}}>Copyright © 2020 All Rights Reserved by Veda-The Quiz Society.</p>
     </div>
    </footer>
    </center>
  );
